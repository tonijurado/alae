...
return array(
    //RUTA BASE
    "base_url"              => "http://www.alae.com/alae/alae/public",
    "base_url_validation"   => "http://www.alae.com/alae/validaciones/public",
 //"base_url" => "http://www.alaeapp.com",
    //"base_url" => "http://localhost/alae/public",
    "batch_directory"       => "D:\alae2-lotesmuestras",
    "batch_directory_older" => "D:\alae2-lotesmuestrasBKP",
    "mail_host_smtp" 		=> "smtp.anapharmbioanalytics.com",
    "mail_port" 			=> 587,
	"mail_username"			=> "cgp579c",
    "mail_admin_email" 		=> "alae@anapharmbioanalytics.com",
    "mail_password" 		=> "nyCi5IE7",
);
