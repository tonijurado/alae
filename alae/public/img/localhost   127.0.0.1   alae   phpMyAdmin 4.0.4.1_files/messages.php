...
PMA_messages['strNotNumber'] = "¡Ésto no es un número!";
...
PMA_messages['strLiveTrafficChart'] = "Gráfico de tráfico en vivo";
PMA_messages['strLiveConnChart'] = "Gráfico de procesos/conexiones en vivo";
PMA_messages['strLiveQueryChart'] = "Gráfico de consultas en vivo";
PMA_messages['strStaticData'] = "Datos estáticos";
...
PMA_messages['strInvalidResponseExplanation'] = "Al pedir un nuevo gráfico el servidor devolvió una respuesta inválida. Esto es probablemente porque expiró la sesión. Cargar la página nuevamente y volver a ingresar sus credenciales debería ayudar.";
...
PMA_messages['enum_hint'] = "Ingresar cada valor en un campo separado";
