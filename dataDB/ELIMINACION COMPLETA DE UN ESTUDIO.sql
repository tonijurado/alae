...
-- 		(
-- 			SELECT pk_batch FROM alae_batch WHERE alae_batch.fk_study IN (397)
-- 		)
-- 	);
-- 	
...
-- WHERE alae_batch_nominal.fk_batch IN (	SELECT pk_batch FROM alae_batch WHERE alae_batch.fk_study IN (397));
...
-- WHERE alae_sample_batch.fk_batch IN  (	SELECT pk_batch FROM alae_batch WHERE alae_batch.fk_study IN (397));
-- 
-- Borrado de alae_batch
DELETE FROM alae_batch WHERE pk_batch IN (8268,8269,);
-- DELETE FROM alae_batch WHERE alae_batch.fk_study IN (397);
-- -- 
